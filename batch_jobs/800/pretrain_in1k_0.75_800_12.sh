...
python -m src.pretrain --config-name=pretrain_in1k_0.75_800 resume_from_checkpoint=/work3/s184202/thesis/thesis-mae-in1k/pretrain_outputs/checkpoints/pretrain_in1k_0.75_800/version_11/last.ckpt